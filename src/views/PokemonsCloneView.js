...
class PokemonsViewClone extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <h1>{`${firstName} ${lastName}'s ${this.props.pokemonStore.pageTitle} Clone`}</h1>
...
export default inject("userStore", "pokemonStore")(observer(PokemonsViewClone));